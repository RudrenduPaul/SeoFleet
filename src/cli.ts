...
program
  .command("init")
  .description("Scaffold a SeoFleet setup (seofleet.json + a Claude Code skill file) into a target directory")
...
program
  ...
  .argument("<path>", "local project directory containing seofleet.json")
