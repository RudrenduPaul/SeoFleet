...
The simplest possible use of the seofleet library: load_site() fetches the
...
`seofleet check <path>` (minus the seofleet.json file -- here the site URL
is passed directly).
...
from seofleet import ALL_CHECKS, load_site, run_checks
...
def main() -> None:
    ...
    print(f"SeoFleet check -- {site_url}\n")
    for r in results:
